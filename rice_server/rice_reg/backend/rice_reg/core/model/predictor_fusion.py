...
class MultiModalPredictorFusion(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # Locate transformer layers for manual forward (same patterns as predictor_v0.py)
        ...
        # Post-fusion bottleneck at L/4 (predictor_v0-style)
        ...
        # Upsample decoder (same as predictor_v0)
        ...
        # Final head (same as predictor_v0)
